		...
		<div class="panel-body">
   		...
   		<p>A continuación se presenta una lista de preguntas para que usted las responde y a partir de esto se evaluara su desempeño </p>
   			<form class="form-horizontal">
    			...
    			<div class="form-group">
      				<label for="pregunta1">* 1.-¿Cual es tu idea de ser vendedor?: <b>(15 palabras)</b></label>
      				<textarea class="form-control"></textarea>
    			</div>


    			<div class="form-group">
      				<label for="pregunta2">* 2.-Si tuvieras que elegir entre hablar con una persona o trabajar y al mismo tiempo hablar ¿Que escogerias?: </label>
      				<textarea class="form-control"></textarea>
    			</div>
    			
    			
    			<div class="checkbox">
    				<label for="pregunta1"><b>3.- ¿Cual es tu meta económica?</b></label>
      				<ul>
      				<label>
